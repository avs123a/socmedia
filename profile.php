                ...
                if (isset($_POST['follow'])) {
                        ...
                        if ($userid != $followerid) {
                                ...
                                if (!DB::query('SELECT follower_id FROM followers WHERE user_id=:userid AND follower_id=:followerid', array(':userid'=>$userid, ':followerid'=>$followerid))) {
                                        ...
                                        echo '<p style="background-color:#00ffcc">Already following!</p>';
                                }
                                $isFollowing = True;
                        }
                }
                if (isset($_POST['unfollow'])) {
                        ...
                        if ($userid != $followerid) {
                                ...
                                if (DB::query('SELECT follower_id FROM followers WHERE user_id=:userid AND follower_id=:followerid', array(':userid'=>$userid, ':followerid'=>$followerid))) {
										...
										echo '<p style="background-color:#ff6666">Already unfollowing!</p>';
                                }
                                $isFollowing = False;
                        }
                }
...
<body>
    ...
    <div class="container">
        <h1><?php echo $username; ?>'s Profile <?php if ($verified) { echo '<i class="glyphicon glyphicon-ok-sign verified" data-toggle="tooltip" title="Verified User" style="font-size:28px;color:#da052b;"></i>'; } ?></h1>
		  <div>
			   <form name="followform" action="profile.php?username=<?php echo $username; ?>" method="post">
	   <input type="submit" name="follow" value="Follow" class="btn btn-success">
	</form>
	<form name="unfollowform" action="profile.php?username=<?php echo $username; ?>" method="post">
    ...
    <div class="footer-dark">
        <footer>
            <div class="container">
                <p class="copyright">Social Network© 2017</p>
            </div>
        </footer>
    </div>
